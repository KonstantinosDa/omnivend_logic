...
from inventory.views import VendingMachineList,landing_page,dashboard_home,add_machine,add_store,edit_machine,edit_store,add_storage,edit_storage,add_product,edit_product
